...
-- 若主课题已统一维护课题四菜单，重复导入不会重复插入同 path / component / perms 的菜单项。
-- ============================================================
...
INSERT INTO sys_menu (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT '执行样本增强', @menu_resultofen_id, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:resultofen:execute', '#', 'admin', NOW(), '执行样本增强按钮权限'
WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE perms = 'system:resultofen:execute');
INSERT INTO sys_menu (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT '样本增强导出', @menu_resultofen_id, 3, '', '', NULL, 1, 0, 'F', '0', '0', 'system:resultofen:export', '#', 'admin', NOW(), '样本增强导出按钮权限'
...
INSERT INTO sys_menu (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT '执行特征融合', @menu_resultoffu_id, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:resultoffu:execute', '#', 'admin', NOW(), '执行特征融合按钮权限'
WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE perms = 'system:resultoffu:execute');
INSERT INTO sys_menu (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT '特征融合导出', @menu_resultoffu_id, 3, '', '', NULL, 1, 0, 'F', '0', '0', 'system:resultoffu:export', '#', 'admin', NOW(), '特征融合导出按钮权限'
...
INSERT INTO sys_menu (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT '执行故障诊断', @menu_resultofgr_id, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:resultofgr:execute', '#', 'admin', NOW(), '执行故障诊断按钮权限'
WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE perms = 'system:resultofgr:execute');
INSERT INTO sys_menu (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT '诊断结果导出', @menu_resultofgr_id, 3, '', '', NULL, 1, 0, 'F', '0', '0', 'system:resultofgr:export', '#', 'admin', NOW(), '诊断结果导出按钮权限'
...
INSERT INTO sys_menu (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT '执行根因分析', @menu_resultofrc_id, 2, '', '', NULL, 1, 0, 'F', '0', '0', 'system:resultofrc:execute', '#', 'admin', NOW(), '执行根因分析按钮权限'
WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE perms = 'system:resultofrc:execute');
INSERT INTO sys_menu (`menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT '根因分析导出', @menu_resultofrc_id, 3, '', '', NULL, 1, 0, 'F', '0', '0', 'system:resultofrc:export', '#', 'admin', NOW(), '根因分析导出按钮权限'
