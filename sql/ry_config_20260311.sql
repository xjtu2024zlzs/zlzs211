...
INSERT INTO config_info(id, data_id, group_id, content, md5, gmt_create, gmt_modified, src_user, src_ip, app_name, tenant_id, c_desc, c_use, effect, type, c_schema, encrypted_data_key) VALUES
(10,'ruoyi-project1-dev.yml','DEFAULT_GROUP','# spring config\nspring:\n  data:\n    redis:\n      host: localhost\n      port: 6379\n      password: \n  datasource:\n    druid:\n      stat-view-servlet:\n        enabled: true\n        loginUsername: ruoyi\n        loginPassword: 123456\n    dynamic:\n      druid:\n        initial-size: 5\n        min-idle: 5\n        maxActive: 20\n        maxWait: 60000\n        connectTimeout: 30000\n        socketTimeout: 60000\n        timeBetweenEvictionRunsMillis: 60000\n        minEvictableIdleTimeMillis: 300000\n        validationQuery: SELECT 1 FROM DUAL\n        testWhileIdle: true\n        testOnBorrow: false\n        testOnReturn: false\n        poolPreparedStatements: true\n        maxPoolPreparedStatementPerConnectionSize: 20\n        filters: stat,slf4j\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\n      datasource:\n          # master datasource\n          master:\n            driver-class-name: com.mysql.cj.jdbc.Driver\n            url: jdbc:mysql://localhost:3306/ry-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n            username: root\n            password: password\n\n# mybatis config\nmybatis:\n    typeAliasesPackage: com.ruoyi.project1.domain\n    mapperLocations: classpath:mapper/**/*.xml\n\n# springdoc config\nspringdoc:\n  gatewayUrl: http://localhost:8080/${spring.application.name}\n  api-docs:\n    enabled: true\n  info:\n    title: \'project1 service api docs\'\n    description: \'project1 service api description\'\n    contact:\n      name: RuoYi\n      url: https://ruoyi.vip\n',NULL,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'nacos','0:0:0:0:0:0:0:1','','','project1 service',NULL,NULL,'yaml',NULL,'');

UPDATE config_info
SET content = REPLACE(content,
'            - id: ruoyi-file\n              uri: lb://ruoyi-file\n              predicates:\n                - Path=/file/**\n              filters:\n                - StripPrefix=1\n\n# ',
'            - id: ruoyi-file\n              uri: lb://ruoyi-file\n              predicates:\n                - Path=/file/**\n              filters:\n                - StripPrefix=1\n            # project1 service\n            - id: ruoyi-project1\n              uri: lb://ruoyi-project1\n              predicates:\n                - Path=/project1/**\n              filters:\n                - StripPrefix=1\n\n# ')
WHERE data_id = 'ruoyi-gateway-dev.yml' AND group_id = 'DEFAULT_GROUP' AND tenant_id = '';
