...
INSERT INTO t1_dossier_template_chapter (
  ...
  ('ta110900-0900-4900-8900-000000000900', @tpl_v11, NULL, 'NODE_TEMPLATE_ROOT', '卷宗目录', 1, '卷宗目录', 'group', 1, 1, 1, 1, 'strict', '卷宗目录根节点。', '{"objectLevel":"template_group","displayType":"tree_table","sortMode":"business_order","primaryFields":["object_level","chapter_name"],"blocks":["summary","details"],"showMissingTips":true}', 'system', 'system'),
  ('ta110950-0950-4950-8950-000000000950', @tpl_v11, 'ta110900-0900-4900-8900-000000000900', 'AIRCRAFT_DIRECTORY_ROOT', '整机目录', 2, '卷宗目录/整机目录', 'group', 90, 1, 1, 1, 'strict', '整机层目录，和系统、子系统、设备、组件、零件目录同属于卷宗目录。', '{"objectLevel":"aircraft","displayType":"tree_table","sortMode":"business_order","primaryFields":["tail_number","msn","aircraft_type","status"],"blocks":["summary","relation","details","documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta110101-0101-4101-8101-000000000101', @tpl_v11, 'ta110950-0950-4950-8950-000000000950', 'AIRCRAFT_BASIC', '飞机基本信息', 3, '卷宗目录/整机目录/飞机基本信息', 'chapter', 10, 1, 1, 1, 'strict', '记录飞机身份、型号、序列号、交付状态、当前使用状态。', '{"objectLevel":"aircraft","displayType":"summary_table","sortMode":"business_order","primaryFields":["tail_number","msn","aircraft_type","delivery_status","current_status"],"blocks":["summary","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta110102-0102-4102-8102-000000000102', @tpl_v11, 'ta110950-0950-4950-8950-000000000950', 'AIRCRAFT_BOM', '构型 / BOM', 3, '卷宗目录/整机目录/构型 / BOM', 'chapter', 20, 1, 1, 1, 'strict', '展示整机下的系统、子系统、设备、组件、零件结构，点击节点切换下钻目录。', '{"objectLevel":"aircraft","displayType":"tree_table","sortMode":"structure_order","primaryFields":["node_type","part_number","part_name","position_code","serial_number"],"blocks":["summary","relation","details","issues"],"drilldown":true,"showMissingTips":true}', 'system', 'system'),
  ('ta110103-0103-4103-8103-000000000103', @tpl_v11, 'ta110950-0950-4950-8950-000000000950', 'AIRCRAFT_DESIGN', '设计数据', 3, '卷宗目录/整机目录/设计数据', 'chapter', 30, 1, 1, 0, 'strict', '展示整机层面的设计定义、系统划分、构型要求和技术文件。', '{"objectLevel":"aircraft","displayType":"summary_table","sortMode":"business_order","primaryFields":["model","configuration","system","t1_technical_file","design_parameter"],"blocks":["summary","details","documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta110104-0104-4104-8104-000000000104', @tpl_v11, 'ta110950-0950-4950-8950-000000000950', 'AIRCRAFT_MANUFACTURING', '制造数据', 3, '卷宗目录/整机目录/制造数据', 'chapter', 40, 1, 1, 0, 'strict', '展示整机相关制造工单、装配、检验、异常等记录。', '{"objectLevel":"aircraft","displayType":"timeline_files","sortMode":"time_asc","primaryFields":["t1_shop_order","task_code","assembly_time","inspection_result"],"blocks":["summary","timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta110105-0105-4105-8105-000000000105', @tpl_v11, 'ta110950-0950-4950-8950-000000000950', 'AIRCRAFT_SERVICE', '服役数据', 3, '卷宗目录/整机目录/服役数据', 'chapter', 50, 0, 1, 0, 'normal', '展示飞行、维修、装拆、使用状态等记录。', '{"objectLevel":"aircraft","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["flight_leg","t1_work_order","t1_install_removal","tsn_fh"],"blocks":["summary","timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta110106-0106-4106-8106-000000000106', @tpl_v11, 'ta110950-0950-4950-8950-000000000950', 'AIRCRAFT_FAULT', '故障维修', 3, '卷宗目录/整机目录/故障维修', 'chapter', 60, 0, 1, 0, 'normal', '展示故障事件、维修工单、处置动作和关闭情况。', '{"objectLevel":"aircraft","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["fault_code","severity","status","t1_work_order","close_date"],"blocks":["summary","timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta110107-0107-4107-8107-000000000107', @tpl_v11, 'ta110950-0950-4950-8950-000000000950', 'AIRCRAFT_TECH_STATUS', '技术状态', 3, '卷宗目录/整机目录/技术状态', 'chapter', 70, 0, 1, 0, 'normal', '展示构型基线、构型快照、工程更改和状态变化。', '{"objectLevel":"aircraft","displayType":"summary_table","sortMode":"time_desc","primaryFields":["baseline","snapshot","change_order","status"],"blocks":["summary","details","documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta110108-0108-4108-8108-000000000108', @tpl_v11, 'ta110950-0950-4950-8950-000000000950', 'AIRCRAFT_ATTACHMENTS', '附件材料', 3, '卷宗目录/整机目录/附件材料', 'chapter', 80, 0, 1, 0, 'normal', '展示文件、证明、报告、图片和其他材料。', '{"objectLevel":"aircraft","displayType":"file_list","sortMode":"business_order","primaryFields":["doc_no","title","doc_type","file_storage_key"],"blocks":["documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111000-1000-4000-8000-000000001000', @tpl_v11, 'ta110900-0900-4900-8900-000000000900', 'SYSTEM_ROOT', '系统目录', 2, '卷宗目录/系统目录', 'group', 100, 1, 1, 1, 'strict', '系统层关注结构、接口、状态和相关问题。', '{"objectLevel":"system","displayType":"tree_table","sortMode":"business_order","primaryFields":["system_code","system_name","interface","status"],"blocks":["summary","relation","details","documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111001-1001-4001-8001-000000001001', @tpl_v11, 'ta111000-1000-4000-8000-000000001000', 'SYSTEM_OVERVIEW', '系统概况', 3, '卷宗目录/系统目录/系统概况', 'chapter', 101, 1, 1, 1, 'strict', '系统身份、功能和当前状态。', '{"objectLevel":"system","displayType":"summary_table","sortMode":"business_order","primaryFields":["code","name","status","ata_chapter"],"blocks":["summary","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111002-1002-4002-8002-000000001002', @tpl_v11, 'ta111000-1000-4000-8000-000000001000', 'SYSTEM_STRUCTURE', '系统结构', 3, '卷宗目录/系统目录/系统结构', 'chapter', 102, 1, 1, 0, 'strict', '系统下级对象和结构关系。', '{"objectLevel":"system","displayType":"tree_table","sortMode":"structure_order","primaryFields":["node_type","part_number","part_name","position_code"],"blocks":["relation","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111003-1003-4003-8003-000000001003', @tpl_v11, 'ta111000-1000-4000-8000-000000001000', 'SYSTEM_INTERFACE', '接口关系', 3, '卷宗目录/系统目录/接口关系', 'chapter', 103, 0, 1, 0, 'normal', '系统与系统、子系统或设备之间的接口关系。', '{"objectLevel":"system","displayType":"summary_table","sortMode":"business_order","primaryFields":["interface_no","source_node","target_node","status"],"blocks":["relation","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111004-1004-4004-8004-000000001004', @tpl_v11, 'ta111000-1000-4000-8000-000000001000', 'SYSTEM_DESIGN', '系统设计数据', 3, '卷宗目录/系统目录/系统设计数据', 'chapter', 104, 1, 1, 0, 'strict', '系统功能、系统组成、接口关系和系统级技术文件。', '{"objectLevel":"system","displayType":"summary_table","sortMode":"business_order","primaryFields":["system_function","t1_technical_file","revision"],"blocks":["summary","details","documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111005-1005-4005-8005-000000001005', @tpl_v11, 'ta111000-1000-4000-8000-000000001000', 'SYSTEM_TECH_STATUS', '技术状态', 3, '卷宗目录/系统目录/技术状态', 'chapter', 105, 0, 1, 0, 'normal', '系统技术状态、构型基线和更改影响。', '{"objectLevel":"system","displayType":"summary_table","sortMode":"time_desc","primaryFields":["baseline","change_order","effective_status"],"blocks":["summary","details","documents"],"showMissingTips":true}', 'system', 'system'),
  ('ta111006-1006-4006-8006-000000001006', @tpl_v11, 'ta111000-1000-4000-8000-000000001000', 'SYSTEM_FAULT', '相关故障', 3, '卷宗目录/系统目录/相关故障', 'chapter', 106, 0, 1, 0, 'normal', '系统相关故障事件和关闭状态。', '{"objectLevel":"system","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["fault_code","severity","status","reported_at"],"blocks":["summary","timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111007-1007-4007-8007-000000001007', @tpl_v11, 'ta111000-1000-4000-8000-000000001000', 'SYSTEM_MAINTENANCE', '维修记录', 3, '卷宗目录/系统目录/维修记录', 'chapter', 107, 0, 1, 0, 'normal', '系统层维修工单和处置动作。', '{"objectLevel":"system","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["wo_number","wo_status","station","close_date"],"blocks":["timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ...
  ('ta111500-1500-4500-8500-000000001500', @tpl_v11, 'ta110900-0900-4900-8900-000000000900', 'SUBSYSTEM_ROOT', '子系统目录', 2, '卷宗目录/子系统目录', 'group', 150, 1, 1, 1, 'strict', '子系统层关注功能边界、接口、组成设备和相关问题。', '{"objectLevel":"subsystem","displayType":"tree_table","sortMode":"business_order","primaryFields":["subsystem_code","subsystem_name","interface","status"],"blocks":["summary","relation","details","documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111501-1501-4501-8501-000000001501', @tpl_v11, 'ta111500-1500-4500-8500-000000001500', 'SUBSYSTEM_OVERVIEW', '子系统概况', 3, '卷宗目录/子系统目录/子系统概况', 'chapter', 151, 1, 1, 1, 'strict', '子系统身份、功能边界和当前状态。', '{"objectLevel":"subsystem","displayType":"summary_table","sortMode":"business_order","primaryFields":["code","name","status","parent_system"],"blocks":["summary","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111502-1502-4502-8502-000000001502', @tpl_v11, 'ta111500-1500-4500-8500-000000001500', 'SUBSYSTEM_STRUCTURE', '子系统结构', 3, '卷宗目录/子系统目录/子系统结构', 'chapter', 152, 1, 1, 0, 'strict', '子系统下级设备和结构关系。', '{"objectLevel":"subsystem","displayType":"tree_table","sortMode":"structure_order","primaryFields":["node_type","part_number","part_name","position_code"],"blocks":["relation","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111503-1503-4503-8503-000000001503', @tpl_v11, 'ta111500-1500-4500-8500-000000001500', 'SUBSYSTEM_INTERFACE', '接口关系', 3, '卷宗目录/子系统目录/接口关系', 'chapter', 153, 0, 1, 0, 'normal', '子系统与系统、其他子系统或设备之间的接口关系。', '{"objectLevel":"subsystem","displayType":"summary_table","sortMode":"business_order","primaryFields":["interface_no","source_node","target_node","status"],"blocks":["relation","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111504-1504-4504-8504-000000001504', @tpl_v11, 'ta111500-1500-4500-8500-000000001500', 'SUBSYSTEM_EQUIPMENT', '组成设备', 3, '卷宗目录/子系统目录/组成设备', 'chapter', 154, 1, 1, 0, 'strict', '子系统下的设备清单和上下级关系。', '{"objectLevel":"subsystem","displayType":"tree_table","sortMode":"structure_order","primaryFields":["node_type","part_number","part_name","position_code"],"blocks":["relation","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111505-1505-4505-8505-000000001505', @tpl_v11, 'ta111500-1500-4500-8500-000000001500', 'SUBSYSTEM_DESIGN', '子系统设计数据', 3, '卷宗目录/子系统目录/子系统设计数据', 'chapter', 155, 1, 1, 0, 'strict', '子系统功能边界、组成设备、接口关系和子系统级技术文件。', '{"objectLevel":"subsystem","displayType":"summary_table","sortMode":"business_order","primaryFields":["subsystem_function","t1_technical_file","revision"],"blocks":["summary","details","documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111506-1506-4506-8506-000000001506', @tpl_v11, 'ta111500-1500-4500-8500-000000001500', 'SUBSYSTEM_TECH_STATUS', '技术状态', 3, '卷宗目录/子系统目录/技术状态', 'chapter', 156, 0, 1, 0, 'normal', '子系统技术状态、构型基线和更改影响。', '{"objectLevel":"subsystem","displayType":"summary_table","sortMode":"time_desc","primaryFields":["baseline","change_order","effective_status"],"blocks":["summary","details","documents"],"showMissingTips":true}', 'system', 'system'),
  ('ta111507-1507-4507-8507-000000001507', @tpl_v11, 'ta111500-1500-4500-8500-000000001500', 'SUBSYSTEM_FAULT', '相关故障', 3, '卷宗目录/子系统目录/相关故障', 'chapter', 157, 0, 1, 0, 'normal', '子系统相关故障事件和关闭状态。', '{"objectLevel":"subsystem","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["fault_code","severity","status","reported_at"],"blocks":["summary","timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111508-1508-4508-8508-000000001508', @tpl_v11, 'ta111500-1500-4500-8500-000000001500', 'SUBSYSTEM_MAINTENANCE', '维修记录', 3, '卷宗目录/子系统目录/维修记录', 'chapter', 158, 0, 1, 0, 'normal', '子系统层维修工单和处置动作。', '{"objectLevel":"subsystem","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["wo_number","wo_status","station","close_date"],"blocks":["timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta111509-1509-4509-8509-000000001509', @tpl_v11, 'ta111500-1500-4500-8500-000000001500', 'SUBSYSTEM_ATTACHMENTS', '附件材料', 3, '卷宗目录/子系统目录/附件材料', 'chapter', 159, 0, 1, 0, 'normal', '子系统级文件和证明附件。', '{"objectLevel":"subsystem","displayType":"file_list","sortMode":"business_order","primaryFields":["doc_no","title","file_storage_key"],"blocks":["documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta112000-2000-4000-8000-000000002000', @tpl_v11, 'ta110900-0900-4900-8900-000000000900', 'EQUIPMENT_ROOT', '设备目录', 2, '卷宗目录/设备目录', 'group', 200, 1, 1, 1, 'strict', '设备层关注组成、设计、制造、装配、装机和维护记录。', '{"objectLevel":"equipment","displayType":"tree_table","sortMode":"business_order","primaryFields":["part_number","part_name","position_code","status"],"blocks":["summary","relation","details","documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta112001-2001-4001-8001-000000002001', @tpl_v11, 'ta112000-2000-4000-8000-000000002000', 'EQUIPMENT_BASIC', '设备基本信息', 3, '卷宗目录/设备目录/设备基本信息', 'chapter', 201, 1, 1, 1, 'strict', '设备编号、名称、位置和状态。', '{"objectLevel":"equipment","displayType":"summary_table","sortMode":"business_order","primaryFields":["part_number","part_name","position_code","serial_number"],"blocks":["summary","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta112002-2002-4002-8002-000000002002', @tpl_v11, 'ta112000-2000-4000-8000-000000002000', 'EQUIPMENT_STRUCTURE', '组成结构', 3, '卷宗目录/设备目录/组成结构', 'chapter', 202, 1, 1, 0, 'strict', '设备下级组件或零件。', '{"objectLevel":"equipment","displayType":"tree_table","sortMode":"structure_order","primaryFields":["node_type","part_number","part_name","position_code"],"blocks":["relation","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta112003-2003-4003-8003-000000002003', @tpl_v11, 'ta112000-2000-4000-8000-000000002000', 'EQUIPMENT_DESIGN', '设计数据', 3, '卷宗目录/设备目录/设计数据', 'chapter', 203, 1, 1, 0, 'strict', '设备结构、组成关系、装配要求、设备级技术文件。', '{"objectLevel":"equipment","displayType":"summary_table","sortMode":"business_order","primaryFields":["part_number","material_spec","t1_technical_file","revision"],"blocks":["summary","details","documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta112004-2004-4004-8004-000000002004', @tpl_v11, 'ta112000-2000-4000-8000-000000002000', 'EQUIPMENT_MANUFACTURING', '制造数据', 3, '卷宗目录/设备目录/制造数据', 'chapter', 204, 1, 1, 0, 'strict', '设备制造工单、工序和异常。', '{"objectLevel":"equipment","displayType":"timeline_files","sortMode":"time_asc","primaryFields":["t1_shop_order","route_code","task_code","status"],"blocks":["summary","timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta112005-2005-4005-8005-000000002005', @tpl_v11, 'ta112000-2000-4000-8000-000000002000', 'EQUIPMENT_ASSEMBLY_RECORD', '装配记录', 3, '卷宗目录/设备目录/装配记录', 'chapter', 205, 1, 1, 0, 'strict', '设备装配过程和关键参数。', '{"objectLevel":"equipment","displayType":"timeline_files","sortMode":"time_asc","primaryFields":["assembly_time","assembled_by_id","verified_by_id","assembly_params"],"blocks":["timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta112006-2006-4006-8006-000000002006', @tpl_v11, 'ta112000-2000-4000-8000-000000002000', 'EQUIPMENT_INSPECTION', '检验记录', 3, '卷宗目录/设备目录/检验记录', 'chapter', 206, 1, 1, 0, 'strict', '设备检验和试验记录。', '{"objectLevel":"equipment","displayType":"summary_table","sortMode":"time_desc","primaryFields":["inspection_type","inspection_std_doc","result","inspection_date"],"blocks":["summary","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta112007-2007-4007-8007-000000002007', @tpl_v11, 'ta112000-2000-4000-8000-000000002000', 'EQUIPMENT_INSTALL', '装机履历', 3, '卷宗目录/设备目录/装机履历', 'chapter', 207, 1, 1, 0, 'strict', '设备装机、拆换和当前装机位置。', '{"objectLevel":"equipment","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["install_date","position_code","tsn_fh","tsn_fc"],"blocks":["summary","timeline","details"],"showMissingTips":true}', 'system', 'system'),
  ('ta112008-2008-4008-8008-000000002008', @tpl_v11, 'ta112000-2000-4000-8000-000000002000', 'EQUIPMENT_FAULT', '故障维修', 3, '卷宗目录/设备目录/故障维修', 'chapter', 208, 0, 1, 0, 'normal', '设备故障和维修记录。', '{"objectLevel":"equipment","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["fault_code","wo_number","status","resolution_type"],"blocks":["timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta112009-2009-4009-8009-000000002009', @tpl_v11, 'ta112000-2000-4000-8000-000000002000', 'EQUIPMENT_CHANGE', '技术变更', 3, '卷宗目录/设备目录/技术变更', 'chapter', 209, 0, 1, 0, 'normal', '设备级工程更改和状态变化。', '{"objectLevel":"equipment","displayType":"summary_table","sortMode":"time_desc","primaryFields":["change_order","baseline","effective_status"],"blocks":["summary","details","documents"],"showMissingTips":true}', 'system', 'system'),
  ('ta112010-2010-4010-8010-000000002010', @tpl_v11, 'ta112000-2000-4000-8000-000000002000', 'EQUIPMENT_ATTACHMENTS', '附件材料', 3, '卷宗目录/设备目录/附件材料', 'chapter', 210, 0, 1, 0, 'normal', '设备相关附件。', '{"objectLevel":"equipment","displayType":"file_list","sortMode":"business_order","primaryFields":["doc_no","title","file_storage_key"],"blocks":["documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta113000-3000-4000-8000-000000003000', @tpl_v11, 'ta110900-0900-4900-8900-000000000900', 'COMPONENT_ROOT', '组件目录', 2, '卷宗目录/组件目录', 'group', 300, 1, 1, 1, 'strict', '组件层关注零件组成、制造追溯、检验、装配和使用情况。', '{"objectLevel":"component","displayType":"tree_table","sortMode":"business_order","primaryFields":["part_number","part_name","serial_number","status"],"blocks":["summary","relation","details","documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta113001-3001-4001-8001-000000003001', @tpl_v11, 'ta113000-3000-4000-8000-000000003000', 'COMPONENT_BASIC', '组件基本信息', 3, '卷宗目录/组件目录/组件基本信息', 'chapter', 301, 1, 1, 1, 'strict', '组件身份和状态。', '{"objectLevel":"component","displayType":"summary_table","sortMode":"business_order","primaryFields":["part_number","part_name","serial_number","status"],"blocks":["summary","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta113002-3002-4002-8002-000000003002', @tpl_v11, 'ta113000-3000-4000-8000-000000003000', 'COMPONENT_PARTS', '组成零件', 3, '卷宗目录/组件目录/组成零件', 'chapter', 302, 1, 1, 0, 'strict', '组件包含的零件。', '{"objectLevel":"component","displayType":"tree_table","sortMode":"structure_order","primaryFields":["part_number","part_name","serial_number","is_critical"],"blocks":["relation","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta113003-3003-4003-8003-000000003003', @tpl_v11, 'ta113000-3000-4000-8000-000000003000', 'COMPONENT_DESIGN', '设计数据', 3, '卷宗目录/组件目录/设计数据', 'chapter', 303, 1, 1, 0, 'strict', '组件组成、关键参数、制造和装配要求。', '{"objectLevel":"component","displayType":"summary_table","sortMode":"business_order","primaryFields":["part_number","t1_technical_file","design_parameter"],"blocks":["summary","details","documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta113004-3004-4004-8004-000000003004', @tpl_v11, 'ta113000-3000-4000-8000-000000003000', 'COMPONENT_TRACE', '制造追溯', 3, '卷宗目录/组件目录/制造追溯', 'chapter', 304, 1, 1, 0, 'strict', '组件制造工单、工序和追溯信息。', '{"objectLevel":"component","displayType":"timeline_files","sortMode":"time_asc","primaryFields":["t1_shop_order","task_code","material_lot","operation_record"],"blocks":["summary","timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta113005-3005-4005-8005-000000003005', @tpl_v11, 'ta113000-3000-4000-8000-000000003000', 'COMPONENT_INSPECTION', '检验记录', 3, '卷宗目录/组件目录/检验记录', 'chapter', 305, 1, 1, 0, 'strict', '组件检验记录。', '{"objectLevel":"component","displayType":"summary_table","sortMode":"time_desc","primaryFields":["inspection_type","result","inspection_date"],"blocks":["summary","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta113006-3006-4006-8006-000000003006', @tpl_v11, 'ta113000-3000-4000-8000-000000003000', 'COMPONENT_ASSEMBLY_REL', '装配关系', 3, '卷宗目录/组件目录/装配关系', 'chapter', 306, 0, 1, 0, 'normal', '组件装配关系。', '{"objectLevel":"component","displayType":"tree_table","sortMode":"structure_order","primaryFields":["parent_node","child_node","position_code"],"blocks":["relation","details"],"showMissingTips":true}', 'system', 'system'),
  ('ta113007-3007-4007-8007-000000003007', @tpl_v11, 'ta113000-3000-4000-8000-000000003000', 'COMPONENT_INSTALL', '装机履历', 3, '卷宗目录/组件目录/装机履历', 'chapter', 307, 1, 1, 0, 'strict', '组件装机位置和装拆履历。', '{"objectLevel":"component","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["install_date","position_code","tsn_fh","tsn_fc"],"blocks":["summary","timeline","details"],"showMissingTips":true}', 'system', 'system'),
  ('ta113008-3008-4008-8008-000000003008', @tpl_v11, 'ta113000-3000-4000-8000-000000003000', 'COMPONENT_SERVICE', '服役记录', 3, '卷宗目录/组件目录/服役记录', 'chapter', 308, 0, 1, 0, 'normal', '组件服役巡检和维护记录。', '{"objectLevel":"component","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["flight_leg","t1_inspection_record","t1_work_order"],"blocks":["timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta113009-3009-4009-8009-000000003009', @tpl_v11, 'ta113000-3000-4000-8000-000000003000', 'COMPONENT_FAULT', '故障维修', 3, '卷宗目录/组件目录/故障维修', 'chapter', 309, 0, 1, 0, 'normal', '组件故障和维修。', '{"objectLevel":"component","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["fault_code","wo_number","status"],"blocks":["timeline","details","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta113010-3010-4010-8010-000000003010', @tpl_v11, 'ta113000-3000-4000-8000-000000003000', 'COMPONENT_CERT', '证明附件', 3, '卷宗目录/组件目录/证明附件', 'chapter', 310, 0, 1, 0, 'normal', '组件证明和附件。', '{"objectLevel":"component","displayType":"file_list","sortMode":"business_order","primaryFields":["doc_no","title","file_storage_key"],"blocks":["documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta114000-4000-4000-8000-000000004000', @tpl_v11, 'ta110900-0900-4900-8900-000000000900', 'PART_ROOT', '零件目录', 2, '卷宗目录/零件目录', 'group', 400, 1, 1, 1, 'strict', '零件层关注设计定义、制造来源、装机位置、使用履历和证明材料。', '{"objectLevel":"part","displayType":"part_card_param_table","sortMode":"business_order","primaryFields":["part_number","part_name","serial_number","batch_number","is_critical"],"blocks":["summary","relation","params","documents","issues"],"showMissingTips":true}', 'system', 'system'),
  ('ta114001-4001-4001-8001-000000004001', @tpl_v11, 'ta114000-4000-4000-8000-000000004000', 'PART_BASIC', '零件基本信息', 3, '卷宗目录/零件目录/零件基本信息', 'chapter', 401, 1, 1, 1, 'strict', '件号、名称、序列号、批次号和关键性。', '{"objectLevel":"part","displayType":"part_card_param_table","sortMode":"business_order","primaryFields":["part_number","part_name","serial_number","batch_number","manufacturer","is_critical"],"blocks":["summary","relation","details","issues"],"demoFocus":"HYD-TUBE-MLG-32A","showMissingTips":true}', 'system', 'system'),
  ('ta114002-4002-4002-8002-000000004002', @tpl_v11, 'ta114000-4000-4000-8000-000000004000', 'PART_DESIGN', '设计数据', 3, '卷宗目录/零件目录/设计数据', 'chapter', 402, 1, 1, 0, 'strict', '件号、材料、尺寸、参数、寿命、关键性、技术文件、替代关系。液压弯管展示冲击仿真模型。', '{"objectLevel":"part","displayType":"part_card_param_table","sortMode":"business_order","primaryFields":["part_number","material_spec","outer_diameter_mm","wall_thickness_mm","design_pressure_mpa","proof_pressure_mpa","doc_number"],"blocks":["summary","params","documents","issues"],"demoFocus":"HYD-TUBE-MLG-32A","showMissingTips":true}', 'system', 'system'),
  ('ta114003-4003-4003-8003-000000004003', @tpl_v11, 'ta114000-4000-4000-8000-000000004000', 'PART_TRACE', '制造追溯', 3, '卷宗目录/零件目录/制造追溯', 'chapter', 403, 1, 1, 0, 'strict', '制造工单、工序任务、原材料批次、加工记录、检验记录、制造异常和证明文件。', '{"objectLevel":"part","displayType":"timeline_files","sortMode":"time_asc","primaryFields":["t1_shop_order","task_code","material_lot","operation_record","inspection_result"],"blocks":["summary","timeline","details","documents","issues"],"demoFocus":"HT-MLG-32A-2026-0042","showMissingTips":true}', 'system', 'system'),
  ('ta114004-4004-4004-8004-000000004004', @tpl_v11, 'ta114000-4000-4000-8000-000000004000', 'PART_INSPECTION', '检验记录', 3, '卷宗目录/零件目录/检验记录', 'chapter', 404, 1, 1, 0, 'strict', '来料复验、终检、气密和尺寸检验。', '{"objectLevel":"part","displayType":"summary_table","sortMode":"time_desc","primaryFields":["inspection_type","inspection_std_doc","measurement_values","result","inspection_date"],"blocks":["summary","details","issues"],"demoFocus":"HYD-LEAK-CHK-32A","showMissingTips":true}', 'system', 'system'),
  ('ta114005-4005-4005-8005-000000004005', @tpl_v11, 'ta114000-4000-4000-8000-000000004000', 'PART_INSTALL', '装机履历', 3, '卷宗目录/零件目录/装机履历', 'chapter', 405, 1, 1, 0, 'strict', '装机飞机、装机位置、装拆动作和装机参数。', '{"objectLevel":"part","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["tail_number","position_code","install_date","torque_n_m","leak_check_result"],"blocks":["summary","timeline","details","issues"],"demoFocus":"B-1234","showMissingTips":true}', 'system', 'system'),
  ('ta114006-4006-4006-8006-000000004006', @tpl_v11, 'ta114000-4000-4000-8000-000000004000', 'PART_SERVICE', '服役维修', 3, '卷宗目录/零件目录/服役维修', 'chapter', 406, 0, 1, 0, 'normal', '服役巡检、维护工单和装拆履历。', '{"objectLevel":"part","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["tsn_fh","tsn_fc","wo_number","t1_inspection_record","t1_install_removal"],"blocks":["timeline","details","issues"],"demoFocus":"WO-B1234-2026-0329","showMissingTips":true}', 'system', 'system'),
  ('ta114007-4007-4007-8007-000000004007', @tpl_v11, 'ta114000-4000-4000-8000-000000004000', 'PART_FAULT', '故障记录', 3, '卷宗目录/零件目录/故障记录', 'chapter', 407, 0, 1, 0, 'normal', '零件关联故障和关闭情况。', '{"objectLevel":"part","displayType":"timeline_files","sortMode":"time_desc","primaryFields":["fault_code","fault_description","severity","status","resolution_type"],"blocks":["summary","timeline","details","issues"],"demoFocus":"32-HYD-PULSE-01","showMissingTips":true}', 'system', 'system'),
  ('ta114008-4008-4008-8008-000000004008', @tpl_v11, 'ta114000-4000-4000-8000-000000004000', 'PART_CERT', '证明附件', 3, '卷宗目录/零件目录/证明附件', 'chapter', 408, 0, 1, 0, 'normal', '图纸、材料规范、仿真报告、工卡和证明文件。', '{"objectLevel":"part","displayType":"file_list","sortMode":"business_order","primaryFields":["doc_no","title","doc_type","file_storage_key"],"blocks":["documents","issues"],"demoFocus":"C919-32-1187","showMissingTips":true}', 'system', 'system');
