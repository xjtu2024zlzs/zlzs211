...
import com.ruoyi.flowable.workflow.config.FlowableRemoteUserClient;
import com.ruoyi.flowable.workflow.domain.bo.WfTaskBo;
import com.ruoyi.flowable.workflow.domain.vo.WfFormVo;
import com.ruoyi.flowable.workflow.domain.vo.WfTaskVo;
import com.ruoyi.flowable.workflow.service.IWfDeployFormService;
import com.ruoyi.flowable.workflow.service.IWfInstanceService;
...
public class WfInstanceServiceImpl extends FlowServiceFactory implements IWfInstanceService {
    ...
    private final FlowableRemoteUserClient flowableRemoteUserClient;
            ...
            taskInstanceList.forEach(taskInstance -> {
                ...
                if (StringUtils.isNotBlank(taskInstance.getAssignee())) {
                    ...
                    if(!StringUtils.isNull(user) && !StringUtils.isNull(user.getData())) {
                        ...
                        taskVo.setAssigneeName(user.getData().getNickName());
                    }
                }
                // 展示审批人员
