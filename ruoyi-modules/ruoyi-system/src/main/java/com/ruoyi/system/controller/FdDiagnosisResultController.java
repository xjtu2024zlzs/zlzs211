...
import com.ruoyi.system.service.IFdDiagnosisResultService;
...
public class FdDiagnosisResultController extends BaseController
{
     ...
     * 查询故障诊断-诊断结果列表
     */
    @RequiresPermissions("system:resultofgr:list")
    @GetMapping("/list")
     ...
     * 导出故障诊断-诊断结果列表
     */
    @RequiresPermissions("system:resultofgr:export")
     ...
     * 获取故障诊断-诊断结果详细信息
     */
    @RequiresPermissions("system:resultofgr:query")
     ...
     * 新增故障诊断-诊断结果
     */
    @RequiresPermissions("system:resultofgr:add")
     ...
     * 修改故障诊断-诊断结果
     */
    @RequiresPermissions("system:resultofgr:edit")
     ...
     * 删除故障诊断-诊断结果
     */
    @RequiresPermissions("system:resultofgr:remove")
     ...
     *   @RequiresPermissions("system:resultofgr:execute")
     */
    @PostMapping("/run")
