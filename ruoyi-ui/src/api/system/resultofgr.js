...
export function getResultofgr(diagnosisId) {
  return request({
    url: '/system/resultofgr/' + diagnosisId,
    method: 'get'
  })
}
...
export function pythonTest() {
  return request({
    url: '/system/resultofgr/pythonTest',
    method: 'get'
  })
}
...
export function runDiagnosisByFile(data) {
  return request({
    url: '/system/resultofgr/runByFile',
    method: 'post',
    data: data
  })
}
...
export function rootCauseAnalysis(diagnosisId) {
  return request({
    url: '/system/resultofgr/rootCause/' + diagnosisId,
    method: 'post'
  })
}
export function runDiagnosis(data) {
  return request({
    url: '/system/resultofgr/run',
    method: 'post',
    data: data
  })
}