...
const TEXT_FIXED_API_CONFIG = {
  hierarchy: {
    method: 'GET',
    endpoint: 'http://localhost:8088/project1/dossier/openapi/project3/hierarchy/export?partNumber=HYD-TUBE-MLG-32A',
  ...
  partProcess: {
    method: 'GET',
    endpoint: 'http://localhost:8088/project1/dossier/openapi/project3/part-process/export?partNumber=HYD-TUBE-MLG-32A',
